...
uint64_t get_address_unsigned_immediate(ARMState* state, uint64_t imm12, uint8_t register_xn);
// Pre-Indexed (I = 1)
uint64_t get_address_pre_indexed(ARMState* state, int64_t simm9, uint8_t register_xn);
// Post-Indexed (I = 0)
uint64_t get_address_post_indexed(ARMState* state, int64_t simm9, uint8_t register_xn);
// Register Offset 
